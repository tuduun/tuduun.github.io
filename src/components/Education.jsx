    ...
    <section id="education">
      ...
      >
        <div className={layout.sectionImgReverse}>
          ...
          {/* gradient start */}
          <div className="absolute z-[3] -left-1/2 top-0 w-[0%] h-[50%] rounded-full white__gradient" />
          <div className="absolute z-[0] w-[0%] h-[50%] -left-1/2 bottom-0 rounded-full pink__gradient" />
          {/* gradient end */}
        </div>
